...
@export var playback_stage_texture: Texture2D
@export var result_stage_texture: Texture2D
...
func _prepare_playback(report: Dictionary) -> void:
	stage_art.texture = playback_stage_texture
...
func _render_final_report(report: Dictionary) -> void:
	stage_art.texture = result_stage_texture
