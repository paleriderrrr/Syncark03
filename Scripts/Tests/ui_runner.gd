...
func _run() -> void:
	...
	_assert(warrior_stats_label != null, "Warrior tab should include a dedicated stats label")
	_assert(hunter_stats_label != null, "Hunter tab should include a dedicated stats label")
	_assert(mage_stats_label != null, "Mage tab should include a dedicated stats label")
	if warrior_stats_label != null:
		_assert(warrior_stats_label.text.contains("HP "), "Warrior tab stats should show current and max HP")
		_assert(warrior_stats_label.text.contains("ATK "), "Warrior tab stats should show attack")
		_assert(warrior_stats_label.text.contains("INT "), "Warrior tab stats should show attack interval")
	if hunter_stats_label != null:
		_assert(hunter_stats_label.text.contains("HP "), "Hunter tab stats should show current and max HP")
		_assert(hunter_stats_label.text.contains("ATK "), "Hunter tab stats should show attack")
		_assert(hunter_stats_label.text.contains("INT "), "Hunter tab stats should show attack interval")
	if mage_stats_label != null:
	...
	_assert(editor.get_node_or_null("BattlePopup/Margin/RootVBox/Header/StartBattleButton") != null, "Battle popup should expose a Start Battle button")
